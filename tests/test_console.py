...
from astraszab_hypermodern_python import console
...
def test_main_succeeds(runner: CliRunner, mock_wikipedia_random_page: Mock) -> None:
    result = runner.invoke(console.main)
    assert result.exit_code == 0


def test_main_prints_title(runner: CliRunner, mock_wikipedia_random_page: Mock) -> None:
    result = runner.invoke(console.main)
